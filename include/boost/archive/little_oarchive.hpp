 ...
 *
 * Based on the little archive example by Robert Ramey this implementation
...
namespace boost { namespace archive {
	 ...
	 */
	class little_oarchive : public portable_oprimitive
		...
		, public basic_binary_oarchive<little_oarchive>
	{
...
//				save<unsigned>(archive_version);
	...
	public:
		 ...
		 */
		little_oarchive(std::ostream& os, unsigned flags = 0)
			: portable_oprimitive(*os.rdbuf(), flags & no_codecvt)
			, basic_binary_oarchive<little_oarchive>(flags)
		{
			init(flags);
		}

		little_oarchive(std::streambuf& sb, unsigned flags = 0)
			...
			save(const T & t, dummy<3> = 0)
		{
			...
			default: throw little_archive_exception(t);
			}
	...
	typedef detail::polymorphic_oarchive_route<little_oarchive> polymorphic_little_oarchive;

} } // namespace boost::archive

// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::archive::little_oarchive)
BOOST_SERIALIZATION_REGISTER_ARCHIVE(boost::archive::polymorphic_little_oarchive)
...
namespace boost { namespace archive {
	...
	template class basic_binary_oarchive<little_oarchive>;
	...
	template class detail::archive_serializer_map<little_oarchive>;
