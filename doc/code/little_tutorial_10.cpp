 ...
 *
 * This example shows how use little archives combined with on-the-fly 
...
void do_gzipped_out (void)
{
  ...
  string filename = "little_10.data.gz"; 
  ...
  // Save to little archive :
  {
    // Create an output little archive attached to the output file :
    boost::archive::little_oarchive olittle (zout);
...
void do_gzipped_in (void)
{
  ...
  // Load from little archive :
  {
    ...
    boost::archive::little_iarchive ilittle (zin);
